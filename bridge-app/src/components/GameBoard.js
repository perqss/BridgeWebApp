    ...
    useEffect(() => {
        ...
        const renderCardsNorth = (cards) => {
            cardsNorth.forEach((updatedCard, index) => {
                ...
                card.on('pointerdown', () => {
                    playCard(this, card, width * 0.5, height * 0.4, index, spacing, 0, cardsComponentsNorth, 
        ...
        cardsSouth.forEach((updatedCard, index) => {
            ...
            card.on('pointerdown', () => {
                playCard(this, card, width * 0.5, height * 0.6, index, spacing, 0, cardsComponentsSouth, 
        ...
        cardBacks.forEach((updatedCard, index) => {
            ...
            card.y = height * 0.15 + index * spacing;
            cardsComponentsWest.push(card);
            card.on('pointerdown', () => {
                playCard(this, card, width * 0.45, height * 0.5, index, 0, spacing, cardsComponentsWest,
        ...
        cardBacks.forEach((updatedCard, index) => {
            ...
            card.on('pointerdown', () => {
                playCard(this, card, width * 0.55, height * 0.5, index, 0, spacing, cardsComponentsEast,
